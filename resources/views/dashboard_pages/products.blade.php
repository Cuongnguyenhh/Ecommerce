                    ...
                    <div class="form-group">
                        <button class="btn btn-success" type="submit"
                            style="margin-left: 10px; margin-right: 10px; float: right;"><a style="color: white;"
                                href="{{ route('products.create') }}">Add new product</a></button>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="/frontend/img/product/{{ $imgProduct }}"
                                                            class="avatar avatar-sm me-3" alt="user1">
                                                    </div>
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $product->product_name }}</h6>
                                                        <p class="text-xs text-secondary mb-0">{{ $product->category_name }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            @elseif ($product->product_visible == 1)
                                                <td class="align-middle text-center text-sm">
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select id="product_visible"
                                                                                        ...
                                                                                        class="form-control" required>
                                                                                        <option value="0"
                                                                                            {{ $product->product_visible == 0 ? 'selected' : '' }}>
                                                                                            Selling</option>
                                                                                        <option value="1"
                                                                                            {{ $product->product_visible == 1 ? 'selected' : '' }}>
                                                                                            Stop</option>
                                                                                    </select>
                                                                                </div>
