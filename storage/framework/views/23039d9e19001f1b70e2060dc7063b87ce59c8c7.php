                                    ...
                                    <div class="product__item__pic set-bg" data-setbg="img/product/<?php echo e($imgproduct); ?>">
                                        <ul class="product__hover">
                                            <li><a href="<?php echo e(url('/')); ?>"><img src="img/icon/heart.png"
                                                        alt=""></a></li>
                                            <li><a href="<?php echo e(url('/productdetail?id_pro='.$product->product_id)); ?>"><img src="img/icon/compare.png"
                                                        alt=""> <span>Compare</span></a>
                                            </li>
                                            <li><a href="<?php echo e(asset(url('/productdetail?id_pro=' . $product->product_id))); ?>"><img src="img/icon/search.png" alt=""></a></li>
