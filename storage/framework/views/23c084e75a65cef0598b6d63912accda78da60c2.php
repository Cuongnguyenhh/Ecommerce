                ...
                <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                <p>Name<span>*</span></p>
                                <input name="name" type="text" value="<?php echo e($user->name); ?>"  class="checkout__input__add" required> 
                         
                            </div>
                          
                            <div class="checkout__input">
                                <p>Address<span>*</span></p>
                                <input name="addr" type="text" value="<?php echo e($user->user_adress); ?>" class="checkout__input__add" required>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="checkout__order">
                            ...
                            <div class="checkout__input__checkbox">
                                ...
                                <p style="font-family: monospace; font-size: 12px;">(IF YOU DONT CHOICE YOUR PAYMENT WAY WE WAS GET COD FOR YOU )</p>
                            </div>
